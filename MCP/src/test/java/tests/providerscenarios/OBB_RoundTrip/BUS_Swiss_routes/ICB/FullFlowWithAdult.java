package tests.providerscenarios.OBB_RoundTrip.BUS_Swiss_routes.ICB;
...
public class FullFlowWithAdult extends BaseTest {
    ...
    @Test(groups = {"demo"}, dataProvider = "GrazHbf_KlagenfurtHbf", dataProviderClass = TestDataProvider.class)
