package tests.providerscenarios.SBB;
...
public class FullFlowAdultChildRT extends BaseTest {
    @Test(groups = {"dev", "test", "demo"}, dataProvider = "StGallenCH_Lausanne", dataProviderClass = TestDataProvider.class)
    public void RoundTripAdultChildFullFlow(String dep, String arr) {
        ...
        searchPage.setOutwardTime("1300");
