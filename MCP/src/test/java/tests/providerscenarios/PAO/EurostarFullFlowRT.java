...
public class EurostarFullFlowRT extends BaseTest {
    @Test(groups = {"dev", "test", "demo"}, dataProvider = "LondonStPancras_ParisNord", dataProviderClass = TestDataProvider.class)
...
//        s_assert.assertTrue(refundPage.retrieveDetails.status.getText().equals("Cancelled"),"status not found");
        s_assert.assertAll();
    }
}
