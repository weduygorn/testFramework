...
public class BookingConfirmationPageTealiumTest extends BaseTest {


    @Test(groups = {"dev", "test", "demo"})
    public void checkBookingPageTealium() {
        ...
        s_assert.assertTrue(digitalData.getString("pageInstanceId").equals("DEV_PARTNER_CheckBook_EN") || digitalData.getString("pageInstanceId").equals("PROD_PARTNER_CheckBook_EN"), "pageInstanceId");
        ...
        s_assert.assertTrue(digitalData.getString("page.pageInfo.pageID").equals("PARTNER_CheckBook_EN"), "pageID");
        ...
        s_assert.assertTrue(digitalData.getString("page.pageInfo.pageName").equals("PARTNER_IBE_DEU_EN_MCP_CheckBook"), "pageName");
        s_assert.assertTrue(digitalData.getString("page.pageInfo.pageNameSpecific").equals("CheckBook"), "pageNameSpecific");
...
//        //suchparameter
        s_assert.assertTrue(digitalData.getString("suchparameter.start.name").equals("Munich Hbf"), "name");
...
//        //cart
        ...
        s_assert.assertTrue(digitalData.getString("cart.item[0].product.verbindung[0].start.name").equals("Munich Hbf"), "name");
