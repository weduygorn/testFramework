...
public class MixedBahnCard1classMessageAssertion extends BaseTest {
    @Test(groups = {"dev", "test", "demo"})
    public void bahnCardMix1classTest() {
        String mcpUrl = "/request/C=2&PA[1]=30&PC[1]=1&PT[1]=E&PA[2]=30&PC[2]=3&PT[2]=E&OB=8000261$8300120$YYYYMMDD1311$YYYYMMDD1811$EC+89";
