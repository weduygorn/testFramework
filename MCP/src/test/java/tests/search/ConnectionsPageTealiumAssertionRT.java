...
public class ConnectionsPageTealiumAssertionRT extends BaseTest {

    @Test(groups = {"dev", "test", "demo"}, dataProvider = "RomaTermini_MilanoCentrale", dataProviderClass = TestDataProvider.class)
    public void connectionTealiumRT(String dep, String arr) {
        ...
        s_assert.assertTrue(digitalData.getString("suchparameter.reisedatumRueck").contains("-"), "reisedatumRueck");
        s_assert.assertTrue(digitalData.getString("suchparameter.reisezeitRueckVon").contains(":"), "reisezeitRueckVon");
        ...
        s_assert.assertTrue(digitalData.getString("verbindung[0].ankunft").contains(":"), "ankunft");
        s_assert.assertTrue(digitalData.getString("verbindung[0].richtung").contains("R"), "richtung");
        s_assert.assertAll();
    }
}
