 ...
 */
public class TicketAndReservationRTTealiumTest extends BaseTest {


    @Test(groups = {"dev", "test", "demo"})
    public void ticketAndReservationRTTealiumTest() {
        ...
        s_assert.assertTrue(digitalData.getString("cart.item[0].product.productInfo.productId").length() > 5, "productId");
