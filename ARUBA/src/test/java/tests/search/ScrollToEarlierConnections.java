...
public class ScrollToEarlierConnections extends BaseTest implements Logging {

    @Test(groups = {"dev", "test", "demo", "stage", "prod"}, dataProvider = "searchByDeparture", dataProviderClass = TestDataProvider.class)
    public void scrollToEarlierConnections(String originName, String destinationName, String dateValue, String timeValue, String searchMode) {
    ...
    @Test(groups = {"dev", "test", "demo", "stage", "prod"}, dataProvider = "checkNoOfferAvailableCardWithEarlier", dataProviderClass = TestDataProvider.class)
    public void checkNoOffersAvailableCardWithEarlier(String originName, String destinationName, String dateValue, String timeValue, String searchMode) {
