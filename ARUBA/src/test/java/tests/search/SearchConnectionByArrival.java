...
public class SearchConnectionByArrival extends BaseTest implements Logging {

    @Test(groups = "prod", dataProvider = "searchByArrival", dataProviderClass = TestDataProvider.class)
    public void searchAvailableConnection(String originName, String destinationName, String dateValue, String timeValue, String searchMode) {
    ...
    public void searchAvailableConnectionAndPurchase(String originName, String destinationName, String dateValue, String timeValue, String searchMode) {
